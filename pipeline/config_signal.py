...
# ══════════════════════════════════════════════════════════════════════════════
# LightGBM base-model hyper-parameters
# ══════════════════════════════════════════════════════════════════════════════
...
# Per-timeframe overrides merged on top of LGB_PARAMS before training
LGB_PARAMS_OVERRIDE: dict[str, dict] = {
    "15m": {
        "n_estimators":          3000,
...
# ══════════════════════════════════════════════════════════════════════════════
# LightGBM meta-model hyper-parameters (Layer 2 cap calibrator)
# ══════════════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════════════
# Phase D — Three-Layer Stack settings
# ══════════════════════════════════════════════════════════════════════════════

# Layer 3 MPE regressor path (set to None to disable)
MPE_MODEL_PATH = MODEL_DIR / "mpe_regressor_15m.pkl"

# Blending weights: P_final = P_base × BLEND_BASE + P_cal × BLEND_CAL
BLEND_BASE = 0.70
BLEND_CAL  = 0.30
