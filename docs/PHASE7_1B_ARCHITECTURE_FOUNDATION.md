...
`configs/contracts/phase7_scientific_baseline_v1_9.json`; contract tests fail
on any further byte drift in the authoritative successor. It retains Phase 7
version 1.8.0 after the approved discovery checkpoint and audited
source-quality exclusion amendment.
...
|---|---|
| Baseline identity | `phase7_scientific_baseline_v1_9` |
| Phase 7 version | `1.8.0` |
